...
this.rxcomp=this.rxcomp||{};this.rxcomp.http=(function(exports,rxcomp,rxjs,operators){'use strict';function _defineProperties(target, props) {
...
})(exports.HttpEventType || (exports.HttpEventType = {}));var HttpHeaders = function () {
...
}(_wrapNativeSuper(Error));var HttpHeaderResponse = function () {
      ...
      if (rxcomp.isPlatformBrowser && request.hydrate && rxcomp.TransferService.has(stateKey)) {
        ...
        var onLoad = function onLoad() {
          ...
          if (ok) {
            ...
            var httpErrorResponse = new HttpErrorResponse(options);
            rxcomp.nextError$.next(httpErrorResponse);
...
};var HttpHandler = function HttpHandler() {};var HttpUrlEncodingCodec = function () {
